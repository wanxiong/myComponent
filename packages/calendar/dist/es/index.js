...
function CalendarSelect(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: 'bg',
    onClick: onClose
  }), isOpen && /*#__PURE__*/React.createElement(ModalOverflow, null), /*#__PURE__*/React.createElement("div", {
    className: 'selectWrap'
  }, /*#__PURE__*/React.createElement("div", {
    className: 'selectHeader'
  }, headerRender ? headerRender : /*#__PURE__*/React.createElement("div", {
    className: 'banner',
    onClick: onClose
  }, /*#__PURE__*/React.createElement("span", {
    className: 'closeIcon'
  }, /*#__PURE__*/React.createElement("font", null)), /*#__PURE__*/React.createElement("div", {
    className: 'title'
  }, title || '选择日期'), /*#__PURE__*/React.createElement("div", null)), /*#__PURE__*/React.createElement("div", {
    className: 'weekWrap'
  }, /*#__PURE__*/React.createElement("em", null, "\u4E00"), /*#__PURE__*/React.createElement("em", null, "\u4E8C"), /*#__PURE__*/React.createElement("em", null, "\u4E09"), /*#__PURE__*/React.createElement("em", null, "\u56DB"), /*#__PURE__*/React.createElement("em", null, "\u4E94"), /*#__PURE__*/React.createElement("em", null, "\u516D"), /*#__PURE__*/React.createElement("em", null, "\u65E5"))), /*#__PURE__*/React.createElement("div", {
    ...
    }, firstDateStr), /*#__PURE__*/React.createElement("div", {
...
var getMonthDateRange = (function (firstDate) {
  // 当月第一天星期
  var firstDay = moment(firstDate).startOf('month').day(); // 日历第一天前的空格数量

  var firstBlank = firstDay === 0 ? 6 : firstDay - 1; // 当前月最大天数

  var maxDate = moment(firstDate).endOf('month').date(); // 天数数组

  var dateRangeArr = range_1(1, maxDate + 1).map(function (item) {
    return moment(firstDate).date(item);
  });
...
function Calendar(_ref) {
  ...
  var _useState = useState(startDate ? moment(startDate) : null),
      _useState2 = slicedToArray(_useState, 2),
      startMoment = _useState2[0],
      setStartMoment = _useState2[1];

  var _useState3 = useState(endDate ? moment(endDate) : null),
      _useState4 = slicedToArray(_useState3, 2),
      endMoment = _useState4[0],
      setEndMoment = _useState4[1];

  var _useState5 = useState(defaultDate || moment()),
  ...
  var initMonthArr = function initMonthArr(changeMonth) {
    var currentDate = moment().date(1).hours(0).minutes(0).seconds(0).milliseconds(0); // 最近 3 个月日历

    var monthArr = [];

    for (var i = 0; i < Number(changeMonth || 1); i++) {
      var firstDate = moment(currentDate).add(i, 'months');
      monthArr.push({
        firstDate: firstDate,
  ...
  var dateCellRender = function dateCellRender(currentMoment, index) {
    ...
    if (nowDateStr === dateStr) {
      ...
      }, isSameStart && isSameEnd ? /*#__PURE__*/React.createElement("div", {
        className: 'tipText'
      }, "\u5DF2\u9009") : isSameStart ? /*#__PURE__*/React.createElement("div", {
        className: 'tipText'
      }, "\u5F00\u59CB") : isSameEnd ? /*#__PURE__*/React.createElement("div", {
        className: 'tipText'
      }, "\u7ED3\u675F") : null, /*#__PURE__*/React.createElement("div", null, currentMoment.date()), dateCellBottomRender && dateCellBottomRender(currentMoment, index));
    }
  };
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CalendarSelect, {
